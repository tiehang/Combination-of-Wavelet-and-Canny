...
imag=cv2.imread('F:\program file\canopy\Project\lena.jpg',0);
[row,col]=imag.shape;
row2=int(row*0.5);
col2=int(col*0.5);
row3=int(row2*0.5);
...
imag_canny_thre=canny_thre(imag_canny_comb,row,col,20,10);
...
imag_canny2_thre_sup=canny_thre(imag_canny2_comb_sup,row,col,30,10);
